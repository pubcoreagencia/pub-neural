...
-- Migration File: 0002_projector_engine_v0.sql
-- Classification: OPERATIONAL PROJECTOR & REPLAY ENGINE (V0.1 BASELINE)
-- Target: PostgreSQL 16+ / 17+ (Supabase compatible with extensions schema)
-- ============================================================================
